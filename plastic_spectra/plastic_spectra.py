...
class plastic_spectra:
    ...
    def plot_spectra(self, title = 'Annotation results', random_plot = False):    
        ...
        plt.show()
        plt.savefig(f'{title}_experimental_spectra.png')
        ...
        if random_plot == True:
            ...
            plt.show()
            plt.savefig(f'{title}_experimental_spectra_with_random_matches.png')
        ...
        plt.show()
        plt.savefig(f'{title}_experimental_spectra_without_random_matches.png')
